...
namespace ListServiceManagement.Areas.HelpPage
{
    /// <summary>
    ...
    public static class HelpPageConfig
    {
        [SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters",
            MessageId = "ListServiceManagement.Areas.HelpPage.TextSample.#ctor(System.String)",
        ...
        public static void Register(HttpConfiguration config)
        {
            ...
            foreach (Type t in new Type[] { typeof(UpdatedElistContact), typeof(NewElistContact) })
            {
