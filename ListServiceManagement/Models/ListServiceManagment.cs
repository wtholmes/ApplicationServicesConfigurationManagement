...
namespace ListServiceManagement.Models
{
    ...
    public partial class ListServiceManagment : DbContext
    {
        ...
        /// </summary>
        public ListServiceManagment() : base("name=ListServiceManagement")
        {
            Database.SetInitializer<ListServiceManagment>(new ListServiceManagmentDBInitializer());
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
        public class ListServiceManagmentDBInitializer : CreateDatabaseIfNotExists<ListServiceManagment>
        {
            ...
            protected override void Seed(ListServiceManagment context)
            {
